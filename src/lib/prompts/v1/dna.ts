...
export const DESIGNER_DNA: DesignerProfile[] = [
  ...
  },
  {
    name: 'Wallace Chan',
    era: '1973–present',
    keywords: ['Zen philosophy', 'Wallace Cut', 'titanium', 'butterfly', 'cicada', 'mortise-and-tenon', 'internal light manipulation'],
    signatureTechniques: ['Carving through gemstone', 'meteorite inlay', 'multi-layer transparency', 'titanium mortise-and-tenon', 'Wallace Cut (internal reflection manipulation)', 'Intarsia-style gemstone-on-gemstone inlay'],
    signatureMaterials: ['titanium', 'meteorite', 'carved gemstones', 'jade', 'porcelain'],
    philosophy: "Gemstones have souls. The craftsman's job is to liberate them. The Void is a physical element — light lives in the space we carve.",
  ...
  },
  {
    ...
    era: '1977–present',
    keywords: ['pave gradients', 'oxidized metal', 'surrealist botany', 'micro-pave', 'aluminum anodizing', 'painterly gradient'],
    signatureTechniques: ['Aluminum anodizing', 'color bleeding', 'impossible color combinations', 'hidden settings', 'Painterly Gradient (anodized aluminum bleeding into gemstones)'],
    signatureMaterials: ['aluminum', 'micro-pavé diamonds', 'colored gemstones', 'oxidized silver'],
    philosophy: 'Jewelry should shock the eye before it seduces it. Color is the paint; metal is the hidden canvas.',
  ...
  },
  {
    name: 'Hemmerle',
    era: '1893–present',
    keywords: ['anti-brilliance', 'iron', 'copper', 'wood', 'geometric', 'tension setting', 'raw metal', 'anti-brilliance philosophy'],
    signatureTechniques: ['Raw metal surfaces', 'contrasting materials', 'engineered structures', 'patinated bronze', 'Anti-Brilliance (de-emphasizing sparkle for geological weight)'],
    signatureMaterials: ['iron', 'copper', 'wood', 'raw diamonds', 'bronze', 'white gold'],
    philosophy: 'Precious is a concept, not a material. We use iron and copper to give diamonds geological weight, not brilliance.',
  ...
  },
  {
    name: 'Michelle Ong',
    era: '1980s–present',
    keywords: ['Carnet', 'East-West fusion', 'imperial jade', 'nature motifs', 'titanium lace', 'ruyi', "Scholar's Stones (Gongshi) geometry", 'Tactile Fluidity', 'Chinoiserie reimagined'],
    signatureTechniques: ['Jade carving', 'Chinese symbolism', 'understated elegance', 'titanium filigree', 'Textile-to-Titanium (silk ruffles as articulated metal)'],
    signatureMaterials: ['titanium', 'imperial jade', 'diamonds', 'colored gemstones', 'gold'],
    philosophy: 'East meets West in a whisper, not a shout. Silk and lace reimagined as weightless metal structures.',
